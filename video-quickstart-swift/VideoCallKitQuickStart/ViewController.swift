...
extension ViewController : TVIRoomDelegate {
    func didConnect(to room: TVIRoom) {
        ...
        logMessage(messageText: "You are connected to a QwikEyes agent")
        
       //change above to below code for debugging
        /*
        "Connected to room \(room.name) as \(String(describing: room.localParticipant?.identity))")
        */
